...
DFX erbringt seine Dienstleistung im Umfang des bei ihr auf der DFX-Wallet tatsächlich eingegangenen Betrages. Die Bankgebühren respektive Transaktionsgebühren gehen zu Lasten des Kunden und werden direkt vom ursprünglich einbezahlten Betrag in Abzug gebracht, sofern dies beim Transaktionseingang noch nicht erfolgt war. Allenfalls werden dem Kunden auch Verwaltungsgebühren in Rechnung gestellt. DFX handelt als Eigenhändlerin (Principal): Der nach Abzug allfälliger Bank-, Transaktions- und DFX-Gebühren (siehe weiter unten) verbleibende Betrag gilt mit Gutschrift als Kaufpreis vereinnahmt und geht in das Eigentum von DFX über. Eine treuhänderische Entgegennahme oder Weiterleitung von Kundengeldern findet nicht statt. DFX liefert die gewünschte Kryptowährung aus ihrem Eigenbestand direkt an die vom Kunden angegebene Wallet-Adresse.
...
Die Lieferung erfolgt in der Regel innert weniger Minuten nach Gutschrift des Betrags. In Einzelfällen kann die Verarbeitung länger dauern, sie wird jedoch innerhalb von sieben Werktagen nach Gutschrift abgeschlossen.
