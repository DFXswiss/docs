...
- Tu peux poser des questions dans le chat Telegram de DFX (https://t.me/DFXswiss). Les modérateurs y réagissent très rapidement aux demandes et peuvent généralement aider rapidement. Veuillez noter qu'aucun employé de DFX ne vous contactera par message privé ! Si un prétendu employé de DFX te contacte par message privé, il s'agit d'un escroc et non d'un véritable employé de DFX. Les employés de DFX ne t'écrivent que dans un groupe Telegram public ou dans un chat privé que tu as ouvert, mais jamais dans un chat privé que tu n'as pas ouvert toi-même !
